        ...
        <div class="content">
            ...
            <form class="login-form" @submit.prevent='login'>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix" type="text" v-model='username' />
                </div>
                <br>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">Password</label>
                    <input class="form-control form-control-solid placeholder-no-fix" type="password" v-model='password' /> </div>
...
.login .content {
  background-color: lighten(#eceef1, 10%);
